...
const REQUIRED_CONFIRMATION_TEXT = "Yes, I want to delete it";
...
export default function DeleteAccountModal({
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // On success, redirect or close - the mutation will handle clearing cache
      // The app should handle logout/redirect
      onClose();
  ...
  }, [open, onClose, deleteAccountMutation.isPending]);
          ...
          <div ref={ref}>
              ...
              >
                ...
                <div className="space-y-2 text-center">
                  ...
                  <p className="text-gray-600">
                    ...
                    this account like tracked supplements, user data and passkey
                    details <span className="text-red-600">will be lost</span>.
            ...
            >
              ...
              <Button
                ...
                className="w-full"
                disabled={
                  deleteAccountMutation.isPending || !isConfirmationValid
                }
